...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed = new discord_js_1.EmbedBuilder()
            ...
            .addFields({ name: 'Songs in Queue', value: `${queue.songs.length}`, inline: true }, { name: 'Volume', value: `${queue.volume}%`, inline: true }, { name: 'Loop', value: queue.loop === 0 ? 'Off' : queue.loop === 1 ? 'Song' : 'Queue', inline: true })
