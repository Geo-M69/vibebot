...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const author = pkg.author || config.author || 'unknown';
        ...
        const djsVersion = djs.version || (pkg.dependencies && pkg.dependencies['discord.js']) || 'unknown';
        ...
        if (config.clientId) {
            const inviteUrl = `https://discord.com/oauth2/authorize?client_id=${encodeURIComponent(config.clientId)}&permissions=0&scope=${encodeURIComponent('bot applications.commands')}`;
